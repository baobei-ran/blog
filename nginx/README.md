...
[安装查看](https://github.com/dunwu/nginx-tutorial/blob/master/docs/nginx-ops.md)
...
web 领域开发中，经常采用前后端分离模式。这种模式下，前端和后端分别是独立的 web 应用程序，例如：后端是 PHP程序，前端是 React 或 Vue 应用。
